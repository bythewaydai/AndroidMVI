...
object MavericksViewModelProvider {
    ...
    fun <VM : MVIViewModel<S>, S : MVIState> get(
        ...
        initialStateFactory: MVIStateFactory<VM, S> = RealMavericksStateFactory()
    ): VM {
        ...
        val viewModel: MVIViewModelWrapper<VM, S> = ViewModelProvider(
        ...
        ).get(key, MVIViewModelWrapper::class.java) as MVIViewModelWrapper<VM, S>
