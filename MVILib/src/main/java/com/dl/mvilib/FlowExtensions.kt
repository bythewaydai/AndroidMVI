...
internal fun <T : Any?> Flow<T>.collectLatest(
    ...
    val flow = when {
        MVITestOverrides.FORCE_DISABLE_LIFECYCLE_AWARE_OBSERVER -> this
    ...
    val scope = lifecycleOwner.lifecycleScope + MVI.viewModelConfigFactory.subscriptionCoroutineContextOverride
